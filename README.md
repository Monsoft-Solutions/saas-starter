...
This will create your `.env` file with all required variables:
...
- **[📖 Full Documentation](./docs-dev/README.md)**: Complete system documentation
- **[🔐 Authentication Guide](./docs-dev/auth/)**: BetterAuth and OAuth setup
- **[💳 Stripe Integration](./docs-dev/stripe/)**: Payment processing and webhooks
- **[💎 Design System](./docs-dev/design-system.md)**: Design tokens and components
- **[📧 Email System](./docs-dev/emails.md)**: Email templates and delivery
- **[🧪 Testing Guide](./docs-dev/unit-testing.md)**: Testing framework and patterns
...
# Database Management
pnpm db:setup           # Interactive environment setup
